...
import org.goj.feign.feign.fallback.BaseFeignClientFallback;
 ...
 */
@Component("baseFeignClient")
@FeignClient(name = "base", configuration = BaseFeignClient.MyConfig.class, fallback = BaseFeignClientFallback.class)
public interface BaseFeignClient {
    ...
    Result<Boolean> delete(@RequestParam(value = "url") String url);
    ...
    Result<byte[]> download(@RequestParam(value = "url") String url);
